...
- `apps/mobile/` is an Expo SDK 57 Router application for iOS and Android. Its route
...
- Optional account recovery and credential rotation (anonymous UUID credentials and seats already survive restart)
